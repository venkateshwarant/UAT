...
public class TestForms {
	...
	public static void testFirstNameField() throws InterruptedException {
		driver.get("file:///"+System.getProperty("user.dir")+"/src/main/java/Tutorial2/forms.html");
		Thread.sleep(1000);
	...
	@Test //This should fail as we are asserting lastname field value with the firstname value
	public static void testLastNameField() throws InterruptedException {
		driver.get("file:///"+System.getProperty("user.dir")+"/src/main/java/Tutorial2/forms.html");
		Thread.sleep(1000);
		driver.findElement(By.id("lastname")).sendKeys(lastName);
		Thread.sleep(1000);
		String lNameInForm = driver.findElement(By.id("lastname")).getAttribute("value");
